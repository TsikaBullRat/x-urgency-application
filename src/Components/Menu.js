...
export default function Header({ navigate, list, setVids }) {
    ...
    <View style={styles.contain}>
      ...
      <Card style={styles.menu}>
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <TouchableOpacity onPress={()=>Sort("stroke")}>
            <View>
              <Card style={{
          ...
          <TouchableOpacity onPress={()=>Sort("heartattack")}>
          <View>
          ...
          <TouchableOpacity onPress={()=>Sort("epilepsy")}>
          <View>
          ...
          <TouchableOpacity onPress={()=>Sort("cpr")}>
          <View>
            <Card style={{ width: 50, height: 70, marginLeft: 40, borderRadius: 15, alignItems: 'center', textAlign: 'center', marginTop: 7 }}>
          ...
          <TouchableOpacity onPress={()=>Sort("bleeding")}>
          <View>
          ...
          <TouchableOpacity onPress={()=>Sort("choking")}>
          <View>
            <Card style={{ width: 50, height: 70, marginLeft: 33, borderRadius: 15, alignItems: 'center', textAlign: 'center', marginTop: 7 }}>
          ...
          <TouchableOpacity onPress={()=>Sort("drowning")}>
          <View>
            <Card style={{ width: 50, height: 70, marginLeft: 33, borderRadius: 15, alignItems: 'center', textAlign: 'center', marginTop: 7 }}>
          ...
          <TouchableOpacity onPress={()=>Sort("burn")}>
