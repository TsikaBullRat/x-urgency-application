            ...
            <View>
                ...
                <TouchableOpacity onPress={() => Call("112")} >
                    <Card style={[styles.card7, styles.ShadowProp]}>
                        ...
                        <FontAwesome name="arrows" size={30} color="#fde9e7" style={{ marginTop: 1, marginLeft: 180 }} />
                ...
                <TouchableOpacity onPress={() => Call("10111")}>
                    <Card style={[styles.card, styles.ShadowProp]}>
                        ...
                        <FontAwesome name="car" size={25} color="#fde9e7" style={{ marginTop: 1, marginLeft: 70 }} />
                ...
                <TouchableOpacity onPress={() => Call("10177")} >
                    <Card style={[styles.card1, styles.ShadowProp]}>
                        ...
                        <FontAwesome name="ambulance" size={25} color="#fde9e7" style={{ marginTop: 1, marginLeft: 60 }} />
            ...
            <View>
                ...
                <TouchableOpacity onPress={() => Call("999")} >
                    <Card style={[styles.card2, styles.ShadowProp]}>
                        ...
                        <FontAwesome name="fire" size={30} color="#fde9e7" style={{ marginTop: 1, marginLeft: 65 }} />
