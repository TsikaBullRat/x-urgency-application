  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginTop: 20, alignItems: 'center', justifyContent: 'center' }}>
        <Text style={{ paddingLeft: 25, color: '#F47066', fontSize: 30, fontFamily: 'arial' }}> {'EMERGENCY?'} </Text>
      ...
      <View style={{ alignItems: 'center', justifyContent: 'center' }}>
        <TouchableOpacity onPress={() => Call('0800 428 428')}>
          <Card style={styles.card7}>
            <Text style={{ fontWeight: 'bold', fontSize: 15, marginTop: 5, color: 'white' }}> {`Gender Based Violence Command Center`} </Text>
            <FontAwesome name='transgender' size={30} color='#fff' style={{ marginTop: 1, marginLeft: 5 }} />
            <Text style={{ fontWeight: 'bold', fontSize: 16, marginTop: -1, color: 'white' }} >{`0800 428 428`}</Text>
          </Card>
        </TouchableOpacity>
      </View>
      ...
      <View>
        <TouchableOpacity onPress={() => Call('0800 029 999')}>
          <Card style={styles.card7}>
            <Text style={{ fontWeight: 'bold', fontSize: 15, marginTop: 5, color: 'white' }}> {`National Institute For Communicable Diseases`} </Text>
            <FontAwesome name='plus-square' size={28} color='#fff' style={{ marginTop: 1 }} />
            <Text style={{ fontWeight: 'bold', fontSize: 16, marginTop: -1, color: 'white' }}> {`0800 029 999`} </Text>
          </Card>
        </TouchableOpacity>
      </View>
